...
<x-sidebar.group>
    ...
    <x-sidebar.group-content>
        <x-sidebar.menu>
            {{-- Profile --}}
            <x-sidebar.menu-item>
                <x-sidebar.menu-button :active="request()->routeIs('users.profile')" tooltip="Profile" href="{{ route('users.profile') }}">
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {{-- General Settings --}}
             <x-sidebar.menu-item>
                <x-sidebar.menu-button :active="request()->routeIs('settings')" tooltip="General" href="{{ route('settings') }}">
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
